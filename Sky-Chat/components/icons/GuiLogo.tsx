 ...
 * - 流畅的曲线体现 AI 的智能和流动性
 * 
 * @module components/icons/GuiLogo
 */

import * as React from 'react'

interface GuiLogoProps {
  /** 宽度 */
  width?: number
  /** 高度 */
  height?: number
...
export function GuiLogo({ 
  ...
  return (
    ...
    >
      ...
      <defs>
        {/* 主渐变 - 天空蓝 */}
        <linearGradient id="guiGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
/**
 * Gui Chat Logo Icon - 简化版（用于小尺寸）
 */
export function GuiLogoIcon({ 
  width = 32, 
  height = 32, 
  className = '' 
}: Omit<GuiLogoProps, 'showText'>) {
  return (
    <svg
      width={width}
      height={height}
